...
<!-- Mirrored from themearth.com/demo/html/emeet/view/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Feb 2025 16:06:22 GMT -->
<head>
...
<!--HEADER END-->
    ...
    <main>
        <div class="lgx-page-wrapper lgx-page-wrapper-none">
            ...
            <section>
                <div id="lgx-registration" class="lgx-registration lgx-registration2 lgx-registration-christmas"> <!--lgx-registration2 lgx-registration3 lgx-registration4-->
                    <div class="lgx-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="lgx-registration-area"> <!--lgx-registration-area2 lgx-registration-area3 "-->
                                        <div class="lgx-single-registration-christmas">
                                        ...
                                        <div class="lgx-single-registration-christmas recommended">
                                            <div class="lgx-single-registration-inner">
                                                <div class="single-top">
            ...
            <!--REGISTRATION END-->
            <div class="lgx-speacialgap-area"></div>
            ...
            <section>
                <div class="lgx-registration"> <!--lgx-registration2 lgx-registration3 lgx-registration4-->
                    <div class="lgx-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
            ...
            <section>
                <div class="lgx-registration lgx-registration4"> <!--lgx-registration2 lgx-registration3 lgx-registration4-->
                    <div class="lgx-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
            ...
            <section>
                <div class="lgx-registration lgx-registration2">
                    <div class="lgx-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="lgx-registration-area-simple">
                                        ...
                                        <a class="lgx-btn lgx-btn-red" href="#">Registration</a>
                                    </div>
                                </div>
                            </div>
                        </div><!-- //.CONTAINER -->
