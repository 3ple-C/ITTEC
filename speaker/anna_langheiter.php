...
<!-- Mirrored from themearth.com/demo/html/emeet/view/speaker.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Feb 2025 16:06:22 GMT -->
<head>
                        ...
                        <div class="col-xs-12">
                            <div class="lgx-heading-area">
                                <div class="lgx-heading lgx-heading-white">
                                    <h2 class="heading">Anna Langheiter</h2>
                                </div>
                                <ul class="breadcrumb">
                                    <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
                                    <li><a href="speakers.html">Speakers</a></li>
                                    <li class="active">Anna Langheiter</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--//.ROW-->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <article>
                                <header>
                                    <figure>
                                        <img src="../assets/img/speakers/speaker1.jpg" alt="New"/>
                                    </figure>
                                    <div class="text-area">
                                        <div class="speaker-info">
                                            <h1 class="title"><a href="speaker.html">Anna Langheiter</a></h1>
                                ...
                                <section>
                                    ...
                                    <div>
                                        <h4>Since 2005 – Mind in Motion GmbH (International, German & English)</h4>
                                        <ul>
                                            <li>Training Design Consulting</li>
                                            <li>Training Design Certification Program</li>
                                            <li>Training Design: Using AI for Efficient Training Development</li>
                                            <li>Experiential Learning Certification </li>
                                            <li>Train the Trainer Programs for Face-to-Face and Online training </li>
                                            <li>Blended Learning & Digital Learning Paths</li>
                                            <li>Workshop and Team Development Facilitation</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4>Since 2016 – Senior Trainer for Experiential Learning</h4>
                                    </div>
                                    <div>
                                        <h4>2003 – 2005 – Freelance Trainer (German & English)</h4>
                                        <ul>
                                    ...
                                    <div>
                                        <h4>1999 – 2002 – GE Capital Bank, Vienna</h4>
                                        <ul>
                                            <li>Human Resources, Manager Training & Communication</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4>1996 – 1998 – GE Capital Bank, Vienna</h4>
                                        <ul>
                                            <li>Quality, Six Sigma, Project & Process Management</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4>1994 – 1996 – Lauda Air, Schwechat </h4>
                                        <ul>
                                ...
                                <section>
                                    <div>
                                        <h3>Advanced Training & Certifications</h3>
                                        <ul>
                                            <li>E-Moderation (Gilly Salmon Model) – FH | JOANNEUM GmbH</li>
                                            <li>E-Learning Author – Steinbeis Transfer Institute</li>
                                            <li>Learning Arches for Online Learning – Kaospilot</li>
                                            <li>Gamification (Level 1 & Level 2) – Sententia Gamification</li>
                                            <li>Blended Learning Expert – Katja Bett / Corporate Learning & Change GmbH</li>
                                            <li>Transfer Design Certification – Institut für Transferwirksamkeit</li>
                                            <li>Kirkpatrick Certified Facilitator (Bronze Level) – Kirkpatrick Partners</li>
                                            <li>Certified E-Trainer – e-Training.academy</li>
                                            <li>Learning Process Trainer – Metalog</li>
                                            <li>Experiential Learning (Train-the-Trainer & Advanced Workshop) – Metalog</li>
                                            <li>Zürcher Resource Model (ZRM) – Volker Kleinert</li>
                                            <li>Certified Coach (DVBC) – Gunter Schmidt / Milton Erickson Institute Heidelberg</li>
                                            <li>Supervision – Gunter Schmidt / Milton Erickson Institute Heidelberg</li>
                                            <li>Hypnosystemic Coaching & Organizational Development – Gunter Schmidt / Milton Erickson Institute Heidelberg</li>
                                            <li>Agile Project Management with SCRUM – Maxpert</li>
                                            <li>Senior Process Manager – Procon</li>
                                            <li>Visual Communication – Innovation Factory</li>
                                            <li>Mediation & Conflict Management – ARGE Bildungsmanagement</li>
                                            <li>Train the Trainer – Trainerakademie</li>
                                            <li>Dynamic Facilitation – all•in•one•spirit</li>
                                            <li>Managerial Skills Development – General Electric</li>
                                            <li>Advanced Facilitation and Learning Network (AFLN) – General Electric</li>
                                            <li>Master Black Belt – General Electric</li>
                                            <li>Change Acceleration Process – General Electric</li>
                                            <li>Facilitator’s Workshop – General Electric</li>
                                            <li>Black Belt – General Electric</li>
                                            <li>Certified Coach (DVBC)</li>
                                            <li>People-Centered Implementation – Changefirst</li>
                                            <li>Belbin Team Role Behavior – Belbin</li>
                                        </ul>
                                    </div>
                                </section>
                                <section>
                                    <div>
                                        <h3>Author & Publications</h3>
                                        <h4>Author</h4>
                                        <ul>
                                            <li><b>Training Design –</b> How to Develop Well-Thought-Out, Engaging,
                                            and Tailor-Made Training Concepts*, managerSeminare, 2018 </li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4>Co-Author & Contributor</h4>
                                        <ul>
                                            <li><b>80 Games for Live Online Training –</b> Gert Schilling [Ed.], managerSeminare, 2021 </li>
                                            <li><b>The Metalog FieldBook –</b> The Practice of Metalog Training Tools in 58 Case
                                            Studies, Tobias & Daniela Voss [Eds.], BoD – Books on Demand, 2022 </li>
                                            <li><b>Designing Hybrid Trainings & Workshops –</b> Success Models & Concepts,
                                            Inga Geisler & Sandra Dundler, Beltz Verlag, 2023</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h4>Awards</h4>
                                        <ul>
                                            <li><b>European Training Award –</b> old for *Training Design Certification Program*</li>
                                            last year</li>
                                            <li><b>Special Award</b> of the European Training Award for the *TD Navi Methods App* </li>
                                        </ul>
                                    </div>
                                </section>
                            </article>
