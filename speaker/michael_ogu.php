                        ...
                        <div class="col-xs-12">
                            <div class="lgx-heading-area">
                                <div class="lgx-heading lgx-heading-white">
                                    <h2 class="heading">Michael Ogu</h2>
                                </div>
                                <ul class="breadcrumb">
                                    <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
                                    <li><a href="speakers.html">Speakers</a></li>
                                    <li class="active">Michael Ogu</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--//.ROW-->
                                ...
                                <header>
                                    ...
                                    <div class="text-area">
                                        <div class="speaker-info">
                                            <h1 class="title"><a href="speaker.html">Michael Ogu</a></h1>
