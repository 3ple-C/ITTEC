                        ...
                        <div class="col-xs-12">
                            <div class="lgx-heading-area">
                                <div class="lgx-heading lgx-heading-white">
                                    <h2 class="heading">Melanie Martinelli</h2>
                                </div>
                                <ul class="breadcrumb">
                                    <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
                                    <li><a href="speakers.html">Speakers</a></li>
                                    <li class="active">Melanie Martinelli</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--//.ROW-->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <article>
                                <header>
                                    ...
                                    <div class="text-area">
                                        <div class="speaker-info">
                                            <h1 class="title"><a href="speaker.html">Melanie Martinelli</a></h1>
                                ...
                                <section>
                                    <p>
                                    Melanie Martinelli combines her entrepreneurial spirit with her extensive experience in L&D to help build memorable and results-based learning experiences. In her roles as the CEO of the Institute for Transfer Effectiveness and Founder of Going Beyond Training, Melanie is passionate about making transfer happen. Melanie is also a Kirkpatrick Certified Facilitator and she applies strong business acumen to support her clients across industries and geographies to make learning stick and demonstrate its value to key stakeholders.
                                    </p>
                                </section>
                            </article>
                        </div>
