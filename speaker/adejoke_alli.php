                        ...
                        <div class="col-xs-12">
                            <div class="lgx-heading-area">
                                <div class="lgx-heading lgx-heading-white">
                                    <h2 class="heading">Adejoke Alli</h2>
                                </div>
                                <ul class="breadcrumb">
                                    <li><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
                                    <li><a href="speakers.html">Speakers</a></li>
                                    <li class="active">Adejoke Alli</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--//.ROW-->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <article>
                                <header>
                                    ...
                                    <div class="text-area">
                                        <div class="speaker-info">
                                            <h1 class="title"><a href="speaker.html">Adejoke Alli</a></h1>
                                ...
                                <section>
                                    <p>
                                    Adejoke Alli is currently the General Manager, Human Resources and Admin at Fidson Healthcare
                                    Plc. In this role, she is responsible for defining, and delivering Fidson’s People and Culture Strategy
                                    which includes driving employee engagement and retention, enhancing Fidson’s employer brand,
                                    shaping the company’s leadership practices, ensuring succession planning for sustainability, as well
                                    as steering organizational learning and development. 
                                    </p>
                                    <p>
                                    Adejoke started her career as a Pharmacist about 20 years ago after obtaining a Bachelor of
                                    Pharmacy Degree from the University of Lagos. At Fidson Healthcare Plc, she achieved many firsts;
                                    first female Regional Sales Manager, first Training Manager and first female appointed as General
                                    Manager.
                                    </p><br>
                                    <p>
                                    Since she took on the role of leading the Human Resources Team, Adejoke has earned over twenty
                                    awards for both her organization and herself. These include the Employer of Choice in the
                                    Pharmaceutical/Healthcare Sector for 4 consecutive years (2021, 2022, 2023 & 2024) by the Nigeria
                                    Employer’s Consultative Association (NECA), one of the Best Workplaces in Nigeria by Great Place
                                    to Work Nigeria (2019/2020) as well as the Best Employer in the Health and Pharmaceutical Sector
                                    by the Chartered Institute of Personnel Management in 2022, 2023 & 2024. A few personal awards
                                    received include Women Leaders Award from Great Place To Work Nigeria, as well as being ranked
                                    1
                                    st out of 49 International Speakers (from all over the world), at the 2021 Champions of Talent
                                    Development International Virtual Conference
                                    </p> <br>
                                    <p>
                                    Adejoke Alli holds a Master’s Degree in Business Administration (MBA), with a specialization track in
                                    Marketing, from the University of Liverpool, United Kingdom. She is a full Member of the Chartered
                                    Institute of Personnel Management (MCIPM), a member of WIMBIZ (Women in Business), an alumni
                                    of WIMBIZ WIMBoard programme, a member of LDNI (Learning & Development Network
                                    International, LDS) and a member of the Nigeria Employers Consultative Association (NECA) under
                                    the Corporate membership platform. <br><br>
                                    Adejoke loves to read and write when she finds the time to. She considers herself a creative person
                                    and in her spare time loves to explore interior design and aesthetics. Given the opportunity, she
                                    would love to travel, sightsee and explore more of what the world has to offer.
                                    </p>
                                    <!-- <blockquote>
